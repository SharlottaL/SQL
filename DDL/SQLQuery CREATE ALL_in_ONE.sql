...
FILENAME    = 'F:\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\Data\PD_411_ALL_IN_ONE.mdf', --Физическое имя файла
SIZE        =  8MB,
MAXSIZE     =  500MB,
FILEGROWTH  =  5MB
)
...
FILENAME    = 'F:\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\Data\PD_411_ALL_IN_ONE_log.ldf',
SIZE        =  8MB,
MAXSIZE     =  500MB,
FILEGROWTH  =  8MB
);
...
CONSTRAINT FK_Grades_Students FOREIGN KEY (student) REFERENCES Student(student_id),
